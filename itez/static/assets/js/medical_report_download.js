$('#download-medical-report-button').on('click', function(e) {
    e.preventDefault();
    ...
    const url = 'download_medical_report';
    $.get(url)
      .done(function pollAsyncResults(data) {
        $('#download-medical-report-button').addClass('buttonload disabled').html('Processing');
        ...
        $.get(pollAsyncUrl)
          .done(function(asyncData, status, xhr) {
            ...
            if (asyncData.state === "SUCCESS") {
              ...
              $('#download-medical-report-button').removeClass('buttonload disabled').text('Download');
              ...
              // overlay
              $('#download-medical-report-button').text('Download')
            }
          ...
          .fail(function(xhr, status, error) {
            ...
            $('#download-medical-report-button').removeClass('buttonload disabled');
